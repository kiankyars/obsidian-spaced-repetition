...
const en: IBaseLocale = {
    ...
    CURRENT_STABILITY_HELP_TEXT: "Current Stability: ",
    CURRENT_DIFFICULTY_HELP_TEXT: "Current Difficulty: ",
    CURRENT_STATE_HELP_TEXT: "Current State: ",
    FSRS_STATE_NEW: "New",
    FSRS_STATE_LEARNING: "Learning",
    FSRS_STATE_REVIEW: "Review",
    FSRS_STATE_RELEARNING: "Relearning",
